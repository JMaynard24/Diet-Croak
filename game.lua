...
function scene:show( event )
   ...
   local sceneGroup = self.view
      ...
      local frog_sheet = graphics.newImageSheet("Spritesheet1.png", frog_opt);
      local sheet = frog_sheet;
      local sequenceData = frog_sequenceData;
   ...
   if (event.phase == "began") then
      ...
      transition.scaleTo(tongue, {xScale=.4, yScale=scaleMax, transition=linear, time=500*scaleMax, onComplete= stopTongue})
   end
   end
   tongueExist = true
